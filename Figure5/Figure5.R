...
Global <-  read.table("LPI_global_null.txt",header=TRUE,sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
...
TR <-  read.table("LPI_terrestrial_null.txt",header=TRUE,sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
...
FW <-  read.table("LPI_freshwater_null.txt",header=TRUE,sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
...
Afro <-  read.table("LPI_Afro_null.txt",header=TRUE,sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
...
Near <-  read.table("LPI_Near_null.txt",header=TRUE,sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
...
Neo <-  read.table("LPI_Neo_null.txt",header=TRUE,sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
...
Indo <-  read.table("LPI_Indo_null.txt",header=TRUE,sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
...
Pale <-  read.table("LPI_Pale_null.txt",header=TRUE,sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
...
png(filename="Figure5.png",width=28,height=12,units="cm",res=300)
