...
png(filename="Figure S6.png",width=22,height=22,units="cm",res=300)
...
plot(rr.gam,pages=0,select=1,cex.axis=1.1, cex.lab= 1.3, mgp=c(2.5,0.6,0), shift=mean(log10(vect_50)),ylim=c(1.95,2.25),
