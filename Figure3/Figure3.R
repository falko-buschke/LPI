...
png(filename="Figure4.png",width=14,height=21,units="cm",res=300)
...
# Plot the axes
plot(0,0,type="n",las=1,xlim=c(1970,2020), ylim=c(0,1.2),ylab="LPI (1970 = 1)",xlab="Year", cex.axis=1.1, cex.lab= 1.3, mgp=c(2.5,0.6,0))
# Add baseline
abline(h=1,col="grey")
...
# Plot the axes
plot(0,0,type="n",xlim=c(0.35,0.55), ylim=c(0,50),las=1, main="",ylab="Density", xlab="LPI in 2020 (1970 = 1)",	cex.axis=1.1, cex.lab= 1.3, mgp=c(2.5,0.6,0))
